...
void createdb(struct database record[100], int n,FILE *fp)
{
...
void display(struct database record[100], FILE *fp)
{
    char ch;
    struct database student;
...
void add(struct database record[100], int n, FILE *fp)
{
	struct database student;
